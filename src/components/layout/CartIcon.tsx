...
import { CartSlideDrawer } from '@/components/cart/CartSlideDrawer';

/**
 * Cart icon with item-count badge.
 * Reads `totalItems` from the Zustand cart store.
 * Opens a slide-out drawer on click instead of navigating to /cart.
...
export default function CartIcon() {
  ...
  return (
    <>
        ...
        {totalItems > 0 && (
          <span
            ...
            className={[
              ...
              'rounded-full bg-[var(--theme-accent)] text-cream',
      ...
      <CartSlideDrawer isOpen={drawerOpen} onClose={() => setDrawerOpen(false)} />
    </>
  );
}
